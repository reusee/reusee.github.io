...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateObject = _taggedTemplateLiteral(['.table .table-striped .latest-data'], ['.table .table-striped .latest-data']),
	    _templateObject2 = _taggedTemplateLiteral(['.dbname'], ['.dbname']),
	    _templateObject3 = _taggedTemplateLiteral(['.query-count'], ['.query-count']),
	    _templateObject4 = _taggedTemplateLiteral(['.Query .', ''], ['.Query .', '']),
	    _templateObject5 = _taggedTemplateLiteral(['.popover .left'], ['.popover .left']),
	    _templateObject6 = _taggedTemplateLiteral(['.popover-content'], ['.popover-content']),
	    _templateObject7 = _taggedTemplateLiteral(['.arrow'], ['.arrow']);
	...
	function DBMon(state, app) {
	  return (0, _index.div)((0, _index.table)((0, _index.$)(_templateObject), (0, _index.tbody)(state.databases.map(function (database) {
	    return (0, _index.t)(DB, database);
	  }))));
	}
	
	function DB(database) {
	  return (0, _index.tr)((0, _index.td)((0, _index.$)(_templateObject2), database.dbname), (0, _index.td)((0, _index.$)(_templateObject3), (0, _index.span)({ classList: database.lastSample.countClassName }, database.lastSample.nbQueries)), database.lastSample.topFiveQueries.map(function (query) {
	    return (0, _index.t)('Query', function (query) {
	      return (0, _index.td)((0, _index.$)(_templateObject4, query.elapsedClassName), query.formatElapsed, (0, _index.div)((0, _index.$)(_templateObject5), (0, _index.div)((0, _index.$)(_templateObject6), query.query), (0, _index.div)((0, _index.$)(_templateObject7))));
	    }, query);
	  }));
	}
	
	var app = new _index.App(document.getElementById('app'), DBMon, {
	  databases: (0, _index.readOnly)(ENV.generateData().toArray()),
	  debug: {}
	});
	
	function load() {
	  app.update('databases', (0, _index.readOnly)(ENV.generateData().toArray()));
